...
/*
Package documents_v1 is a reverse proxy.
...
func request_Documents_GetDocuments_0(ctx context.Context, marshaler runtime.Marshaler, client DocumentsClient, req *http.Request, pathParams map[string]string) (Documents_GetDocumentsClient, runtime.ServerMetadata, error) {
...
func RegisterDocumentsHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DocumentsServer) error {
	...
	mux.Handle("POST", pattern_Documents_GetDocuments_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterDocumentsHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DocumentsClient) error {
	...
	mux.Handle("POST", pattern_Documents_GetDocuments_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/documents.v1.Documents/GetDocuments", runtime.WithHTTPPathPattern("/v1/docs/getdocuments"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Documents_GetDocuments_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Documents_GetDocuments_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Documents_GetDocuments_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "docs", "getdocuments"}, ""))
)

var (
	forward_Documents_GetDocuments_0 = runtime.ForwardResponseStream
)
