...
/*
Package books_v1 is a reverse proxy.
...
func request_Books_ValidateBooks_0(ctx context.Context, marshaler runtime.Marshaler, client BooksClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var metadata runtime.ServerMetadata
	stream, err := client.ValidateBooks(ctx)
	if err != nil {
...
func RegisterBooksHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BooksServer) error {
	...
	mux.Handle("POST", pattern_Books_ValidateBooks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterBooksHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BooksClient) error {
	...
	mux.Handle("POST", pattern_Books_ValidateBooks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/books.v1.Books/ValidateBooks", runtime.WithHTTPPathPattern("/v1/book/sendbooks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Books_ValidateBooks_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Books_ValidateBooks_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Books_ValidateBooks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "book", "sendbooks"}, ""))
)

var (
	forward_Books_ValidateBooks_0 = runtime.ForwardResponseMessage
)
